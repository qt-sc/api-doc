...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ZhihuCaffe.Article();
  });
  ...
  describe('Article', function() {
    it('should create an instance of Article', function() {
      ...
      //var instane = new ZhihuCaffe.Article();
      //expect(instance).to.be.a(ZhihuCaffe.Article);
    });
    ...
    it('should have the property readNum (base name: "readNum")', function() {
      // uncomment below and update the code to test the property readNum
      //var instane = new ZhihuCaffe.Article();
      //expect(instance).to.be();
    });
